            ...
            <form>
                ...
                <div className="flex space-x-6 mb-6">
                    <div>
                        ...
                        <input
                            className="px-4 py-2 text-xl text-gray-700 text-center bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600"
                            type="number"
                            id="bedrooms"
                            value={bedrooms}
                            onChange={onChange}
                ...
                <div className="mb-6">
                    ...
                    <input
                        className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-ou focus:bg-white focus:border-slate-600"
                        type="file"
                        id="images"
                        onChange={onChange}
                        accept=".jpg,.png,.jpeg"
